...
let base_venusaur =
  {
    ...
    max_hp = 80;
    (* Example stats *)
    moves = [ tackle; leech_seed; vine_whip ];
    (* Initial moves *)
...
let base_pikachu =
  {
    ...
    max_hp = 35;
    moves = [ thunder_shock ];
    learnable_moves = [ (22, electro_ball) ];
...
let base_jigglypuff =
  {
    ...
    max_hp = 45;
    moves = [ pound ];
    learnable_moves = [ (18, double_slap) ];
...
let base_gyarados =
  {
    ...
    ptype = Water;
    max_hp = 95;
    moves = [ hydro_pump; bite; dragon_rage ];
...
let base_dragonite =
  {
    ...
    ptype = Flying;
    max_hp = 91;
    moves = [ wing_attack; dragon_rage; slam ];
...
let base_arcanine =
  {
    ...
    ptype = Fire;
    max_hp = 90;
    moves = [ fire_blast; bite; take_down ];
...
let base_tangela =
  {
    ...
    ptype = Grass;
    max_hp = 65;
    moves = [ vine_whip; leech_seed; solar_beam ];
...
let base_victreebel =
  {
    ...
    ptype = Grass;
    max_hp = 80;
    moves = [ razor_leaf; solar_beam; leech_seed ];
...
let base_ninetales =
  {
    ...
    ptype = Fire;
    max_hp = 73;
    moves = [ ember; quick_attack; fire_blast ];
...
let base_magmar =
  {
    ...
    ptype = Fire;
    max_hp = 65;
    moves = [ ember; fire_punch; fire_blast ];
...
let base_lapras =
  {
    ...
    ptype = Water;
    max_hp = 130;
    moves = [ water_gun; ice_beam; hydro_pump ];
...
let base_magneton =
  {
    ...
    ptype = Electric;
    max_hp = 50;
    moves = [ thunder_shock; spark; sonic_boom ];
